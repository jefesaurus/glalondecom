...
get_header(); ?>
  <div id="content" role="main" class="middle smart-padding left-border">
    ...
    ?>
      ...
      <?php 
        $prev_link = get_next_posts_link(__('&laquo; Older Entries'));
        $next_link = get_previous_posts_link(__('Newer Entries &raquo;'));
        if ($next_link || $prev_link) {
          ?>
          <div id="pagination" class="clearfix">
            <div class="next-page"><?php echo $next_link; ?></div>
            <div class="past-page"><?php echo $prev_link; ?></div>
          </div>
          <?php
        }
      ?>
